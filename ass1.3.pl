...
%% found a 3 stack implementation on stackoverflow, here...
%% from "https://stackoverflow.com/questions/61550755/block-world-problem-search-runs-out-of-stack-space"
%% and have a working test in it running, but none of the work there is my own...
%% appart from modifying the test as per below
...
%% 4) TAKES ABOUT 30 MINS TO RUN ON MY MACHINE